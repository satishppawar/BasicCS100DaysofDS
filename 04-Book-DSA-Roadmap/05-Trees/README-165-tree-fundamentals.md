# Day 165 - Tree Fundamentals

Notebook: [165-tree-fundamentals.ipynb](./165-tree-fundamentals.ipynb)

## Basic Notes

What is Tree Fundamentals?
- `Tree Fundamentals` is a core DSA topic from the roadmap.
