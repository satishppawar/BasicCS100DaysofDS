# Day 167 - BFS Traversals

Notebook: [167-bfs-traversals.ipynb](./167-bfs-traversals.ipynb)

## Basic Notes

What is BFS Traversals?
- `BFS Traversals` is a core DSA topic from the roadmap.
