# Day 166 - DFS Traversals

Notebook: [166-dfs-traversals.ipynb](./166-dfs-traversals.ipynb)

## Basic Notes

What is DFS Traversals?
- `DFS Traversals` is a core DSA topic from the roadmap.
