# Day 168 - Tree Properties

Notebook: [168-tree-properties.ipynb](./168-tree-properties.ipynb)

## Basic Notes

What is Tree Properties?
- `Tree Properties` is a core DSA topic from the roadmap.
