# Day 237 - Update Operations

Notebook: [237-update-operations.ipynb](./237-update-operations.ipynb)

## Basic Notes

What is Update Operations?
- `Update Operations` is a core DSA topic from the roadmap.
