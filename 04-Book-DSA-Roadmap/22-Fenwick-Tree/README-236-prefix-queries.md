# Day 236 - Prefix Queries

Notebook: [236-prefix-queries.ipynb](./236-prefix-queries.ipynb)

## Basic Notes

What is Prefix Queries?
- `Prefix Queries` is a core DSA topic from the roadmap.
