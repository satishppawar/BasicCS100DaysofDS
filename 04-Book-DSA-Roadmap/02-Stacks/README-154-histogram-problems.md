# Day 154 - Histogram Problems

Notebook: [154-histogram-problems.ipynb](./154-histogram-problems.ipynb)

## Basic Notes

What is Histogram Problems?
- `Histogram Problems` is a core DSA topic from the roadmap.
