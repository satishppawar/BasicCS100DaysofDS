# Day 150 - Stack Fundamentals

Notebook: [150-stack-fundamentals.ipynb](./150-stack-fundamentals.ipynb)

## Basic Notes

What is Stack Fundamentals?
- `Stack Fundamentals` is a core DSA topic from the roadmap.
