# Day 151 - Expression Evaluation

Notebook: [151-expression-evaluation.ipynb](./151-expression-evaluation.ipynb)

## Basic Notes

What is Expression Evaluation?
- `Expression Evaluation` is a core DSA topic from the roadmap.
