# Day 153 - Next Greater Element

Notebook: [153-next-greater-element.ipynb](./153-next-greater-element.ipynb)

## Basic Notes

What is Next Greater Element?
- `Next Greater Element` is a core DSA topic from the roadmap.
