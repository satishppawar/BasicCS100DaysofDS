# Day 238 - Range Minimum Query

Notebook: [238-range-minimum-query.ipynb](./238-range-minimum-query.ipynb)

## Basic Notes

What is Range Minimum Query?
- `Range Minimum Query` is a core DSA topic from the roadmap.
