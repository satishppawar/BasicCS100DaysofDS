# Day 275 - FAANG Interview Roadmap

Notebook: [275-faang-interview-roadmap.ipynb](./275-faang-interview-roadmap.ipynb)

## Basic Notes

What is FAANG Interview Roadmap?
- `FAANG Interview Roadmap` is a core DSA topic from the roadmap.
