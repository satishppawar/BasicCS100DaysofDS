# Day 272 - Interview Checklist

Notebook: [272-interview-checklist.ipynb](./272-interview-checklist.ipynb)

## Basic Notes

What is Interview Checklist?
- `Interview Checklist` is a core DSA topic from the roadmap.
