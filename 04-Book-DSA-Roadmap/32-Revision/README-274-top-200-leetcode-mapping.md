# Day 274 - Top 200 LeetCode Mapping

Notebook: [274-top-200-leetcode-mapping.ipynb](./274-top-200-leetcode-mapping.ipynb)

## Basic Notes

What is Top 200 LeetCode Mapping?
- `Top 200 LeetCode Mapping` is a core DSA topic from the roadmap.
