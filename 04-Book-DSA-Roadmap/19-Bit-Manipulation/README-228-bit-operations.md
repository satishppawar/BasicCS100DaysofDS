# Day 228 - Bit Operations

Notebook: [228-bit-operations.ipynb](./228-bit-operations.ipynb)

## Basic Notes

What is Bit Operations?
- `Bit Operations` is a core DSA topic from the roadmap.
