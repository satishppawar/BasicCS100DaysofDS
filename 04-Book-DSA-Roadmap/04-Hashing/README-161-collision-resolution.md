# Day 161 - Collision Resolution

Notebook: [161-collision-resolution.ipynb](./161-collision-resolution.ipynb)

## Basic Notes

What is Collision Resolution?
- `Collision Resolution` is a core DSA topic from the roadmap.
