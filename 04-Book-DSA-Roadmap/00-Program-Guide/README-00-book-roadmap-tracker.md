# Day 00 - Book Roadmap Tracker

Notebook: [00-book-roadmap-tracker.ipynb](./00-book-roadmap-tracker.ipynb)

## Basic Notes

What is Book Roadmap Tracker?
- `Book Roadmap Tracker` is a core DSA topic from the roadmap.
