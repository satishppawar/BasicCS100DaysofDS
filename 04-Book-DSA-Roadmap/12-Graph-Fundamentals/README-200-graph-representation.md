# Day 200 - Graph Representation

Notebook: [200-graph-representation.ipynb](./200-graph-representation.ipynb)

## Basic Notes

What is Graph Representation?
- `Graph Representation` is a core DSA topic from the roadmap.
