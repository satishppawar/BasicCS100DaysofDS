# Day 145 - Circular Linked List

Notebook: [145-circular-linked-list.ipynb](./145-circular-linked-list.ipynb)

## Basic Notes

What is Circular Linked List?
- `Circular Linked List` is a core DSA topic from the roadmap.
