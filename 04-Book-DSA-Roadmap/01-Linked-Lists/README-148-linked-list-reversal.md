# Day 148 - Linked List Reversal

Notebook: [148-linked-list-reversal.ipynb](./148-linked-list-reversal.ipynb)

## Basic Notes

What is Linked List Reversal?
- `Linked List Reversal` is a core DSA topic from the roadmap.
