# Day 205 - Connected Components

Notebook: [205-connected-components.ipynb](./205-connected-components.ipynb)

## Basic Notes

What is Connected Components?
- `Connected Components` is a core DSA topic from the roadmap.
