# Day 198 - Count Inversions

Notebook: [198-count-inversions.ipynb](./198-count-inversions.ipynb)

## Basic Notes

What is Count Inversions?
- `Count Inversions` is a core DSA topic from the roadmap.
