# Day 173 - Successor & Predecessor

Notebook: [173-successor-predecessor.ipynb](./173-successor-predecessor.ipynb)

## Basic Notes

What is Successor & Predecessor?
- `Successor & Predecessor` is a core DSA topic from the roadmap.
