# Day 174 - Kth Smallest Element

Notebook: [174-kth-smallest-element.ipynb](./174-kth-smallest-element.ipynb)

## Basic Notes

What is Kth Smallest Element?
- `Kth Smallest Element` is a core DSA topic from the roadmap.
