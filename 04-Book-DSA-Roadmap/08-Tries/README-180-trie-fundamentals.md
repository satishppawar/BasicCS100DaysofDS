# Day 180 - Trie Fundamentals

Notebook: [180-trie-fundamentals.ipynb](./180-trie-fundamentals.ipynb)

## Basic Notes

What is Trie Fundamentals?
- `Trie Fundamentals` is a core DSA topic from the roadmap.
