# Day 183 - Dictionary Problems

Notebook: [183-dictionary-problems.ipynb](./183-dictionary-problems.ipynb)

## Basic Notes

What is Dictionary Problems?
- `Dictionary Problems` is a core DSA topic from the roadmap.
