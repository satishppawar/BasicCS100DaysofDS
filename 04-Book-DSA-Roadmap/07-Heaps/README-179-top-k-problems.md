# Day 179 - Top-K Problems

Notebook: [179-top-k-problems.ipynb](./179-top-k-problems.ipynb)

## Basic Notes

What is Top-K Problems?
- `Top-K Problems` is a core DSA topic from the roadmap.
