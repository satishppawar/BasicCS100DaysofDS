# Day 177 - Heap Operations

Notebook: [177-heap-operations.ipynb](./177-heap-operations.ipynb)

## Basic Notes

What is Heap Operations?
- `Heap Operations` is a core DSA topic from the roadmap.
