# Day 159 - Sliding Window Maximum

Notebook: [159-sliding-window-maximum.ipynb](./159-sliding-window-maximum.ipynb)

## Basic Notes

What is Sliding Window Maximum?
- `Sliding Window Maximum` is a core DSA topic from the roadmap.
