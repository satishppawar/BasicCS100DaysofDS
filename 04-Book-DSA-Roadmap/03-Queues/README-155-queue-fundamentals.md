# Day 155 - Queue Fundamentals

Notebook: [155-queue-fundamentals.ipynb](./155-queue-fundamentals.ipynb)

## Basic Notes

What is Queue Fundamentals?
- `Queue Fundamentals` is a core DSA topic from the roadmap.
