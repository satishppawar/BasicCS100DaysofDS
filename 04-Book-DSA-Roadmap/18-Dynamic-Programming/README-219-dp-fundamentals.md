# Day 219 - DP Fundamentals

Notebook: [219-dp-fundamentals.ipynb](./219-dp-fundamentals.ipynb)

## Basic Notes

What is DP Fundamentals?
- `DP Fundamentals` is a core DSA topic from the roadmap.
