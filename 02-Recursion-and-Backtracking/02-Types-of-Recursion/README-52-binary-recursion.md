# Day 52 - Binary Recursion

Notebook: [52-binary-recursion.ipynb](./52-binary-recursion.ipynb)

## Basic Notes

What is Binary Recursion?
- `Binary Recursion` explains how a function solves a problem by reducing it into smaller subproblems.
- Correctness depends on a valid base case, progress toward termination, and controlled stack usage.

Core theory details:
- Each call triggers two recursive calls.
- Recursion tree size can grow exponentially.
- Memoization often needed to optimize.
