# Day 49 - Tail Recursion

Notebook: [49-tail-recursion.ipynb](./49-tail-recursion.ipynb)

## Basic Notes

What is Tail Recursion?
- `Tail Recursion` explains how a function solves a problem by reducing it into smaller subproblems.
...
- Often convertible to loop form.
- Useful for accumulator-style computation.
