...
Notebook: [62-permutations.ipynb](./62-permutations.ipynb)

## Basic Notes

What is Permutations?
- `Permutations` is a constraint-driven DSA problem typically solved with recursion/backtracking (or DP where applicable).
- A robust solution depends on state definition, decision choices, stopping rules, and pruning conditions.

Core theory details:
- Pattern: position-by-position swapping/backtracking.
- State: current index and chosen order.
