# Day 91 - Combination Sum II

Notebook: [91-combination-sum-ii.ipynb](./91-combination-sum-ii.ipynb)

## Basic Notes

What is Combination Sum II?
- `Combination Sum II` is a constraint-driven DSA problem typically solved with recursion/backtracking (or DP where applicable).
- A robust solution depends on state definition, decision choices, stopping rules, and pruning conditions.

Core theory details:
- Pattern: backtracking with single-use elements.
- State: index, remaining target, duplicate-skip logic.
- Complexity: exponential with pruning and deduplication.
