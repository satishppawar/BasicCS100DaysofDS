# Day 103 - Maximum Product Subarray

Notebook: [103-maximum-product-subarray.ipynb](./103-maximum-product-subarray.ipynb)

## Basic Notes

What is Maximum Product Subarray?
- `Maximum Product Subarray` is a pattern-oriented interview problem from arrays/strings/matrix tracks.
