# Day 104 - Find Minimum in Rotated Sorted Array

Notebook: [104-find-minimum-in-rotated-sorted-array.ipynb](./104-find-minimum-in-rotated-sorted-array.ipynb)

## Basic Notes

What is Find Minimum in Rotated Sorted Array?
- `Find Minimum in Rotated Sorted Array` is a pattern-oriented interview problem from arrays/strings/matrix tracks.
