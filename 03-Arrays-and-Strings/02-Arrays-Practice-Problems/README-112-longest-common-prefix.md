# Day 112 - Longest Common Prefix

Notebook: [112-longest-common-prefix.ipynb](./112-longest-common-prefix.ipynb)

## Basic Notes

What is Longest Common Prefix?
- `Longest Common Prefix` is a pattern-oriented interview problem from arrays/strings/matrix tracks.
