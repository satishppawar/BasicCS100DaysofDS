# Day 102 - Maximum Subarray

Notebook: [102-maximum-subarray.ipynb](./102-maximum-subarray.ipynb)

## Basic Notes

What is Maximum Subarray?
- `Maximum Subarray` is a pattern-oriented interview problem from arrays/strings/matrix tracks.
