# Day 101 - Product of Array Except Self

Notebook: [101-product-of-array-except-self.ipynb](./101-product-of-array-except-self.ipynb)

## Basic Notes

What is Product of Array Except Self?
- `Product of Array Except Self` is a pattern-oriented interview problem from arrays/strings/matrix tracks.
