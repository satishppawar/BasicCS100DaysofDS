# Day 100 - Contains Duplicate

Notebook: [100-contains-duplicate.ipynb](./100-contains-duplicate.ipynb)

## Basic Notes

What is Contains Duplicate?
- `Contains Duplicate` is a pattern-oriented interview problem from arrays/strings/matrix tracks.
