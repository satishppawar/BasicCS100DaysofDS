# Day 107 - 3Sum Closest

Notebook: [107-3sum-closest.ipynb](./107-3sum-closest.ipynb)

## Basic Notes

What is 3Sum Closest?
- `3Sum Closest` is a pattern-oriented interview problem from arrays/strings/matrix tracks.
