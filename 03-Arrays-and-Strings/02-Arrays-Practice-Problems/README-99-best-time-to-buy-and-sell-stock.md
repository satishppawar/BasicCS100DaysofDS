# Day 99 - Best Time to Buy and Sell Stock

Notebook: [99-best-time-to-buy-and-sell-stock.ipynb](./99-best-time-to-buy-and-sell-stock.ipynb)

## Basic Notes

What is Best Time to Buy and Sell Stock?
- `Best Time to Buy and Sell Stock` is a pattern-oriented interview problem from arrays/strings/matrix tracks.
