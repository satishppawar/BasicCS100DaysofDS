# Day 142 - Count of Smaller Numbers After Self

Notebook: [142-count-of-smaller-numbers-after-self.ipynb](./142-count-of-smaller-numbers-after-self.ipynb)

## Basic Notes

What is Count of Smaller Numbers After Self?
- `Count of Smaller Numbers After Self` is a pattern-oriented interview problem from arrays/strings/matrix tracks.
