# Day 135 - Pascal's Triangle II

Notebook: [135-pascal-s-triangle-ii.ipynb](./135-pascal-s-triangle-ii.ipynb)

## Basic Notes

What is Pascal's Triangle II?
- `Pascal's Triangle II` is a pattern-oriented interview problem from arrays/strings/matrix tracks.
