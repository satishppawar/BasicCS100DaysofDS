# Day 141 - Maximal Rectangle

Notebook: [141-maximal-rectangle.ipynb](./141-maximal-rectangle.ipynb)

## Basic Notes

What is Maximal Rectangle?
- `Maximal Rectangle` is a pattern-oriented interview problem from arrays/strings/matrix tracks.
