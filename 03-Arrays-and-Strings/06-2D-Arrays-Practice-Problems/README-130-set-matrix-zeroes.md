# Day 130 - Set Matrix Zeroes

Notebook: [130-set-matrix-zeroes.ipynb](./130-set-matrix-zeroes.ipynb)

## Basic Notes

What is Set Matrix Zeroes?
- `Set Matrix Zeroes` is a pattern-oriented interview problem from arrays/strings/matrix tracks.
