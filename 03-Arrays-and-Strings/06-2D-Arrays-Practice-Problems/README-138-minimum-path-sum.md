...
Notebook: [138-minimum-path-sum.ipynb](./138-minimum-path-sum.ipynb)

## Basic Notes

What is Minimum Path Sum?
- `Minimum Path Sum` is a pattern-oriented interview problem from arrays/strings/matrix tracks.
