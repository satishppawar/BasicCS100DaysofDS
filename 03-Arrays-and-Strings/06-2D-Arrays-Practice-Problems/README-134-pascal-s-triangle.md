# Day 134 - Pascal's Triangle

Notebook: [134-pascal-s-triangle.ipynb](./134-pascal-s-triangle.ipynb)

## Basic Notes

What is Pascal's Triangle?
- `Pascal's Triangle` is a pattern-oriented interview problem from arrays/strings/matrix tracks.
