# Day 131 - Spiral Matrix

Notebook: [131-spiral-matrix.ipynb](./131-spiral-matrix.ipynb)

## Basic Notes

What is Spiral Matrix?
- `Spiral Matrix` is a pattern-oriented interview problem from arrays/strings/matrix tracks.
