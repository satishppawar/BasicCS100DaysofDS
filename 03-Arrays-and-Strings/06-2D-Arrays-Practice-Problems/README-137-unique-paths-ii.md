# Day 137 - Unique Paths II

Notebook: [137-unique-paths-ii.ipynb](./137-unique-paths-ii.ipynb)

## Basic Notes

What is Unique Paths II?
- `Unique Paths II` is a pattern-oriented interview problem from arrays/strings/matrix tracks.
