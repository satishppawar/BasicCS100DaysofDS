# Day 132 - Rotate Image

Notebook: [132-rotate-image.ipynb](./132-rotate-image.ipynb)

## Basic Notes

What is Rotate Image?
- `Rotate Image` is a pattern-oriented interview problem from arrays/strings/matrix tracks.
