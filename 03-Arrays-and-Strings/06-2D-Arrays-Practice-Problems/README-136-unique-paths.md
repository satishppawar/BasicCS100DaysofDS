# Day 136 - Unique Paths

Notebook: [136-unique-paths.ipynb](./136-unique-paths.ipynb)

## Basic Notes

What is Unique Paths?
- `Unique Paths` is a pattern-oriented interview problem from arrays/strings/matrix tracks.
