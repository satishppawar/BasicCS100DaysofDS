# Day 139 - Dungeon Game

Notebook: [139-dungeon-game.ipynb](./139-dungeon-game.ipynb)

## Basic Notes

What is Dungeon Game?
- `Dungeon Game` is a pattern-oriented interview problem from arrays/strings/matrix tracks.
