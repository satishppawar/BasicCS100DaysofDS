# Day 126 - Group Anagrams

Notebook: [126-group-anagrams.ipynb](./126-group-anagrams.ipynb)

## Basic Notes

What is Group Anagrams?
- `Group Anagrams` is a pattern-oriented interview problem from arrays/strings/matrix tracks.
