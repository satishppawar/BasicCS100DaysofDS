# Day 121 - Valid Palindrome

Notebook: [121-valid-palindrome.ipynb](./121-valid-palindrome.ipynb)

## Basic Notes

What is Valid Palindrome?
- `Valid Palindrome` is a pattern-oriented interview problem from arrays/strings/matrix tracks.
