# Day 124 - Longest Repeating Character Replacement

Notebook: [124-longest-repeating-character-replacement.ipynb](./124-longest-repeating-character-replacement.ipynb)

## Basic Notes

What is Longest Repeating Character Replacement?
- `Longest Repeating Character Replacement` is a pattern-oriented interview problem from arrays/strings/matrix tracks.
